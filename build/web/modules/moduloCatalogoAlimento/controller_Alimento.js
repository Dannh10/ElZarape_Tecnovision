...
function selectAlimento(numeroUnicoAlimento) {
     let alimentoSeleccionado = alimentos.find(alimento => alimento.numeroUnicoAlimento === numeroUnicoAlimento);

     if (alimentoSeleccionado) {
         document.getElementById("txtNumUnico").value = alimentoSeleccionado.numeroUnicoAlimento;
         document.getElementById("txtNombre").value = alimentoSeleccionado.nombre;
         document.getElementById("txtPrecio").value = alimentoSeleccionado.precio;
         document.getElementById("txtDescripcion").value = alimentoSeleccionado.descripcion;
         document.getElementById("txtCategoria").value = alimentoSeleccionado.categoria;
         document.getElementById("btnUpdate").classList.remove("disabled");
         document.getElementById("btnDelete").classList.remove("disabled");
         document.getElementById("btnAdd").classList.add("disabled");

         // Mantener el índice para actualización o eliminación.
         indexAlimentoSeleccionado = alimentos.indexOf(alimentoSeleccionado);
     }
 }
